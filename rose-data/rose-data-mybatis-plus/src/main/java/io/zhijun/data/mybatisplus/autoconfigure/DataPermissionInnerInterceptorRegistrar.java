 ...
 */
final class DataPermissionInnerInterceptorRegistrar implements BeanPostProcessor {

    private final DataPermissionHandler dataPermissionHandler;

    DataPermissionInnerInterceptorRegistrar(DataPermissionHandler dataPermissionHandler) {
