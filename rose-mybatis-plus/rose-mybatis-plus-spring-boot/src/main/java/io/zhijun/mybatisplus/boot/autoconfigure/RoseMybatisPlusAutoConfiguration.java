...
@Import({MultitenancyAutoConfiguration.class, io.zhijun.mybatisplus.spring.extension.MyBatisPlusExtensionConfiguration.class, SqlObservationAutoConfiguration.class})
