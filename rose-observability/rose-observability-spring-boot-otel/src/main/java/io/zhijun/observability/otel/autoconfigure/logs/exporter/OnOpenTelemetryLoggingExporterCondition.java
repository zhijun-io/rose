...
class OnOpenTelemetryLoggingExporterCondition extends SpringBootCondition {
    ...
    public ConditionOutcome getMatchOutcome(ConditionContext context, AnnotatedTypeMetadata metadata) {
        Map<String, Object> attributes = metadata.getAnnotationAttributes(
                ConditionalOnOpenTelemetryLoggingExporter.class.getName());
        ...
        ExporterType logsExporterType = StringUtils.hasText(logsExporterTypeString)
                ? ExporterType.valueOf(logsExporterTypeString.toUpperCase()) : null;
