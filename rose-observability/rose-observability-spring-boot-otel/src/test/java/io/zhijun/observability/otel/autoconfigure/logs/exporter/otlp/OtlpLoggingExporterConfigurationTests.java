package io.zhijun.observability.otel.autoconfigure.logs.exporter.otlp;

import io.zhijun.observability.otel.autoconfigure.exporter.OpenTelemetryExporterAutoConfiguration;
import io.zhijun.observability.otel.autoconfigure.logs.exporter.OpenTelemetryLoggingExporterAutoConfiguration;
...
class OtlpLoggingExporterConfigurationTests {
    ...
    void commonEndpointWithPathPreservedForHttpProtobuf() {
        contextRunner
            ...
            .run(context -> {
                ...
                assertThat(connectionDetails.getUrl(io.zhijun.observability.otel.autoconfigure.exporter.otlp.Protocol.HTTP_PROTOBUF))
    ...
    void commonEndpointNotModifiedForGrpc() {
        contextRunner
            ...
            .run(context -> {
                OtlpLoggingConnectionDetails connectionDetails = context.getBean(OtlpLoggingConnectionDetails.class);
                assertThat(connectionDetails.getUrl(io.zhijun.observability.otel.autoconfigure.exporter.otlp.Protocol.GRPC))
