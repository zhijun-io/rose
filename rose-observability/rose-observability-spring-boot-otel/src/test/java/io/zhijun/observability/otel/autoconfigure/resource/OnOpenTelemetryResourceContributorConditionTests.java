...
class OnOpenTelemetryResourceContributorConditionTests {
    ...
    void shouldMatchWhenContributorIsEnabled() {
        environment.setProperty("rose.otel.resource.contributors.test-contributor.enabled", "true");
    ...
    void shouldNotMatchWhenContributorIsDisabled() {
        environment.setProperty("rose.otel.resource.contributors.test-contributor.enabled", "false");
        when(context.getEnvironment()).thenReturn(environment);
