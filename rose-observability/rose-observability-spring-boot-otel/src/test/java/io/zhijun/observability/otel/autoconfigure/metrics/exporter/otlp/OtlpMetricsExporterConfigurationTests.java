...
class OtlpMetricsExporterConfigurationTests {
    ...
    private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            ...
            .withUserConfiguration(io.zhijun.observability.otel.autoconfigure.support.MetricsTestBeans.class);
    ...
    void histogramAggregationConfigurationApplied() {
        contextRunner
            .withPropertyValues("rose.otel.metrics.exporter.histogram-aggregation=base2-exponential-bucket-histogram")
            .run(context -> {
