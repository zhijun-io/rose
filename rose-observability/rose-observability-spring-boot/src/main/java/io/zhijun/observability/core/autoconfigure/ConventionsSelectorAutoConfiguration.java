...
@ConditionalOnProperty(prefix = ObservabilityProperties.CONFIG_PREFIX, name = "enabled", matchIfMissing = true)
...
public class ConventionsSelectorAutoConfiguration {
    ...
    TelemetryConventionsBackend primaryTelemetryConventionsBackend(
            ObservabilityProperties properties, ObjectProvider<TelemetryConventionsBackend> backends) {
