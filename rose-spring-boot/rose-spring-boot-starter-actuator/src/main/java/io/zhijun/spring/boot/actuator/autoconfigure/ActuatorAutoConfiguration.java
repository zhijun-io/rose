...
public class ActuatorAutoConfiguration {
    ...
    static final String TASK_SCHEDULER_PROPERTY_NAME_PREFIX = "rose.actuator.task-scheduler.";
    ...
    static final String DEFAULT_TASK_SCHEDULER_THREAD_NAME_PREFIX = "rose-actuator-task-";
