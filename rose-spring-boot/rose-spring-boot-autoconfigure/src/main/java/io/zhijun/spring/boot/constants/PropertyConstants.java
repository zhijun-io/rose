...
public interface PropertyConstants {
    ...
    String DEFAULT_BASE_PACKAGE = "io.zhijun";
    ...
    String LOGGING_LEVEL_PROPERTY_NAME = ROSE_SPRING_BOOT_PROPERTY_NAME_PREFIX + "logging-level";

    String DEFAULT_LOGGING_LEVEL = "INFO";

    String BASE_PACKAGES_PROPERTY_NAME = ROSE_SPRING_BOOT_PROPERTY_NAME_PREFIX + "conditions.report.base-packages";
