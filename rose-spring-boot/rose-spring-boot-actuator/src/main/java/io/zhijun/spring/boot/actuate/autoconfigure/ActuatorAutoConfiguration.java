package io.zhijun.spring.boot.actuate.autoconfigure;

import static io.zhijun.spring.boot.actuate.constants.PropertyConstants.TASK_SCHEDULER_PROPERTY_NAME_PREFIX;
...
import io.zhijun.spring.boot.actuate.MonitoredThreadPoolTaskScheduler;
