...
| `rose-observation-spring-boot-otel` | `opentelemetry.properties` | `OtlpMetricsExportAutoConfiguration` |
| `rose-observation-spring-boot-micrometer-otlp` | `micrometer-registry-otlp.properties` | 同上（累加） |
