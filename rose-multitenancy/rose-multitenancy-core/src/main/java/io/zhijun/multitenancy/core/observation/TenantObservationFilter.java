package io.zhijun.multitenancy.core.observation;
...
/**
 * An {@link ObservationFilter} that enriches all observations with the current multitenancy
 * identifier from the {@link TenantContext}.
 */
@Incubating
public final class TenantObservationFilter implements ObservationFilter {

    static final String DEFAULT_TENANT_IDENTIFIER_KEY = "multitenancy.id";
