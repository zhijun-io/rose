...
public class HttpTenantResolutionProperties {
    ...
    /**
     * Whether an HTTP multitenancy resolution strategy should be used.
     */
    ...
    /**
     * Configuration for HTTP header multitenancy resolution.
     */
    private final Header header = new Header();

    /**
     * Configuration for HTTP cookie multitenancy resolution.
     */
    private final Cookie cookie = new Cookie();

    /**
     * Configuration for HTTP filter resolving the current multitenancy.
     */
    ...
    public static class Filter {
        ...
        /**
         * Whether the HTTP filter resolving the current multitenancy is enabled.
         */
        private boolean enabled = true;

        /**
         * Comma-separated list of HTTP request paths for which the multitenancy resolution will
         * not be performed.
         */
        private Set<String> ignorePaths = defaultIgnorePaths();

        /**
         * Additional comma-separated list of HTTP request paths for which the multitenancy
         * resolution will not be performed.
         */
        private Set<String> additionalIgnorePaths = Collections.emptySet();

        /**
         * HTTP request paths for which a multitenancy identifier is required when not ignored.
         */
        private Set<String> requiredIncludePaths = Collections.emptySet();

        /**
         * HTTP request paths excluded from multitenancy requirement checks.
         */
