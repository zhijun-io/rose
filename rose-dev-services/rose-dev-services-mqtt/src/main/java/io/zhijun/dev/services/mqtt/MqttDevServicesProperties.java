 ...
 */
@ConfigurationProperties(prefix = MqttDevServicesProperties.CONFIG_PREFIX)
public class MqttDevServicesProperties implements BaseDevServicesProperties {

    public static final String CONFIG_PREFIX = "rose.dev.services.mqtt";
