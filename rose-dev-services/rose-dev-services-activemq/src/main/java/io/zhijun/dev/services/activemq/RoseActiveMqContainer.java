...
/**
 * ActiveMQ Classic container for Rose Dev Services.
 */
final class RoseActiveMqContainer extends GenericContainer<RoseActiveMqContainer> {
    ...
    private final ActiveMqDevServicesProperties properties;

    RoseActiveMqContainer(ActiveMqDevServicesProperties properties) {
