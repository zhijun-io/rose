package io.zhijun.dev.services.core.actuate.endpoint;
...
import io.zhijun.dev.services.core.autoconfigure.DevServicesEndpointAutoConfiguration;
...
class DevServicesEndpointAutoConfigurationTests {
	...
	private static java.util.Map<String, String> createSingleMap(String k, String v) {
        java.util.Map<String, String> m = new java.util.HashMap<String, String>();
        m.put(k, v);
        return m;
    }

	private static java.util.Map<String, String> createMap(String k1, String v1, String k2, String v2) {
        java.util.Map<String, String> m = new java.util.HashMap<String, String>();
        m.put(k1, v1);
        m.put(k2, v2);
        return m;
