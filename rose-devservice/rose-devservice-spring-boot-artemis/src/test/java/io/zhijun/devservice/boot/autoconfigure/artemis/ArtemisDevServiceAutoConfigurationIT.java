...
class ArtemisDevServiceAutoConfigurationIT extends BaseDevServiceAutoConfigurationIT {
    ...
    private final ApplicationContextRunner contextRunner =
            defaultContextRunner(ArtemisDevServicesAutoConfiguration.class);
    ...
    void containerAvailableInDevMode() {
        assertContainerAvailableInDevMode(ArtemisContainer.class, ArtemisContainer.COMPATIBLE_IMAGE_NAME, container -> {
    ...
    void containerConfigurationApplied() {
        ...
        assertContainerConfigurationApplied(ArtemisContainer.class, properties, (context, container) -> {
            ...
            assertThat(context.getEnvironment().getProperty("spring.artemis.mode"))
                    .isEqualTo("native");
            assertThat(context.getEnvironment().getProperty("spring.artemis.broker-url"))
                    .isNotBlank();
            assertThat(context.getEnvironment().getProperty("spring.artemis.user"))
                    .isEqualTo("myusername");
            assertThat(context.getEnvironment().getProperty("spring.artemis.password"))
