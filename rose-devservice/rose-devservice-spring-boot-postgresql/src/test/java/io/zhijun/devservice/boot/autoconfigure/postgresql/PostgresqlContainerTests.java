 ...
 */
class PostgresqlContainerTests extends BaseDevServicesContainerTests<PostgresqlContainer> {

    @Test
    void whenExposedPortsAreNotConfigured() {
        PostgresqlContainer container = new PostgresqlContainer(new PostgresqlDevServiceProperties());
        container.configure();
