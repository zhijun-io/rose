...
import static io.zhijun.devservice.boot.autoconfigure.postgresql.RosePostgreSqlContainer.READY_REGEX;
import static io.zhijun.devservice.boot.autoconfigure.postgresql.RosePostgreSqlContainer.SKIPPING_INITIALIZATION_REGEX;
import static org.assertj.core.api.Assertions.assertThat;

/**
 * Unit test for {@link RosePostgreSqlContainer}.
 */
class RosePostgreSqlContainerTests extends BaseDevServicesContainerTests<RosePostgreSqlContainer> {

    @Test
    void whenExposedPortsAreNotConfigured() {
        RosePostgreSqlContainer container = new RosePostgreSqlContainer(new PostgresqlDevServiceProperties());
        container.configure();
