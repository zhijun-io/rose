package io.zhijun.devservice.autoconfigure.bootstrap;
...
import io.zhijun.devservice.autoconfigure.bootstrap.dev.BootstrapDevProperties;
import io.zhijun.devservice.autoconfigure.bootstrap.test.BootstrapTestProperties;
...
class BootstrapEnvironmentPostProcessor implements EnvironmentPostProcessor, Ordered {
    ...
    public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
        ...
        List<String> currentProfiles = environment.getProperty(
                StandardEnvironment.ACTIVE_PROFILES_PROPERTY_NAME, List.class,
    ...
    private static void addProfiles(List<String> currentProfiles, List<String> additionalProfiles,
