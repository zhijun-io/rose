package io.zhijun.dev.test;

import java.util.Collections;

import org.junit.jupiter.api.Test;

import io.zhijun.dev.api.config.JdbcDevServiceProperties;

import static io.zhijun.dev.api.config.JdbcDevServiceProperties.DEFAULT_DB_NAME;
import static io.zhijun.dev.api.config.JdbcDevServiceProperties.DEFAULT_PASSWORD;
import static io.zhijun.dev.api.config.JdbcDevServiceProperties.DEFAULT_USERNAME;
