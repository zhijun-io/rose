...
import io.zhijun.dev.api.config.BaseDevServiceProperties;
import io.zhijun.dev.api.config.ResourceMapping;
 ...
 *
 * @param <T> the specific {@link BaseDevServiceProperties} implementation type
 */
public abstract class BaseDevServicePropertiesTests<T extends BaseDevServiceProperties> {
