...
/**
 * Abstract base implementation of {@link BaseDevServiceProperties} with the nine common
 * fields shared by all dev service property classes. Subclasses set module-specific
 * defaults (image name, shared flag, startup timeout) in their constructor and add any
 * extra fields they need.
 *
 * @see BaseDevServiceProperties
 */
public abstract class AbstractBaseDevServiceProperties implements BaseDevServiceProperties {
