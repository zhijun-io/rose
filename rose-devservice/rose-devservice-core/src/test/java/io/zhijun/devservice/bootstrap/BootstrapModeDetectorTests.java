package io.zhijun.devservice.bootstrap;

import io.zhijun.devservice.bootstrap.BootstrapMode;
import io.zhijun.devservice.bootstrap.BootstrapModeDetector;
...
class BootstrapModeDetectorTests {
    ...
    void setUp() {
        ...
        originalRoseBootstrapModeProperty = System.getProperty(BootstrapMode.PROPERTY_KEY);
    ...
    void tearDown() {
        ...
        if (originalRoseBootstrapModeProperty == null) {
            System.clearProperty(BootstrapMode.PROPERTY_KEY);
        } else {
            System.setProperty(BootstrapMode.PROPERTY_KEY, originalRoseBootstrapModeProperty);
        }
        originalRoseBootstrapModeProperty = null;
    ...
    void whenRoseBootstrapModePropertyIsSet(String modeValue) {
    ...
    @Test
    void whenRoseBootstrapModePropertyIsSetToInvalidDefaultsToProduction() {
