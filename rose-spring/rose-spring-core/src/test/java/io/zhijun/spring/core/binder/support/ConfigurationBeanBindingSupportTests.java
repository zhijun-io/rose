...
class ConfigurationBeanBindingSupportTests {
    ...
    void isConfigurationBeanDefinitionReturnsTrueWhenSourceMatches() {
        ...
        assertThat(ConfigurationBeanBindingSupport.isConfigurationBeanDefinition(definition))
                .isTrue();
    }

    @Test
    void isConfigurationBeanDefinitionReturnsFalseForNullOrOtherSource() {
        assertThat(ConfigurationBeanBindingSupport.isConfigurationBeanDefinition(null))
                .isFalse();
    ...
    void prefixAffectedMatchesExactPrefixAndNestedKeys() {
        ...
        assertThat(ConfigurationBeanBindingSupport.prefixAffected("app", changedKeys))
                .isTrue();
        assertThat(ConfigurationBeanBindingSupport.prefixAffected("other", changedKeys))
                .isTrue();
        assertThat(ConfigurationBeanBindingSupport.prefixAffected("application", changedKeys))
                .isFalse();
        assertThat(ConfigurationBeanBindingSupport.prefixAffected("db", changedKeys))
                .isFalse();
    }
    ...
    void resolveSubPropertiesReturnsFullMapWhenMultipleIsFalse() {
        ...
        Map<String, Object> resolved = ConfigurationBeanBindingSupport.resolveSubProperties(
                false, "ignored", configurationProperties, new MockEnvironment());
    ...
    void resolveSubPropertiesExtractsSubtreeWhenMultipleIsTrue() {
        ...
        Map<String, Object> resolved = ConfigurationBeanBindingSupport.resolveSubProperties(
                true, "u0", configurationProperties, new MockEnvironment());
