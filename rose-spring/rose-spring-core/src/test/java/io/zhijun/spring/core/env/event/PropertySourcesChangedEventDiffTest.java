...
class PropertySourcesChangedEventDiffTest {
    ...
    void getChangedKeysUnionsAddedAndRemoved() {
        ...
        PropertySourcesChangedEvent event = new PropertySourcesChangedEvent(context, Arrays.asList(
    ...
    void getChangedKeysUsesDiffForReplaced() {
        ...
        PropertySourcesChangedEvent event = new PropertySourcesChangedEvent(context, Collections.singletonList(
                PropertySourceChangedEvent.replaced(context, new MapPropertySource("demo", newMap),
                        new MapPropertySource("demo", oldMap))));
