...
class ImportOptionalSelector implements ImportSelector, BeanClassLoaderAware {
    ...
    private static final Logger log = LoggerFactory.getLogger(ImportOptionalSelector.class);
    ...
    private boolean isPresent(String className) {
        try {
            ...
            log.debug("Optional import [{}] not found on classpath, skipped", className);
            return false;
        }
    }
