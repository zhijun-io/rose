...
public class ConfigurationBeanBindingsRegistrar
    ...
    public void registerBeanDefinitions(AnnotationMetadata metadata, BeanDefinitionRegistry registry) {
        AnnotationAttributes attributes = AnnotationAttributes.fromMap(
                metadata.getAnnotationAttributes("io.zhijun.spring.beans.factory.EnableConfigurationBeanBindings"));
        if (attributes == null) {
            return;
        }
        io.zhijun.spring.beans.factory.ConfigurationBeanBindingRegistrar delegate = new io.zhijun.spring.beans.factory.ConfigurationBeanBindingRegistrar();
