...
/**
 * 监听 {@link ConfigurablePropertyResolver} 的属性解析操作。
 */
public interface PropertyResolverListener {

    default void beforeGetProperty(ConfigurablePropertyResolver propertyResolver, String name, Class<?> targetType, Object defaultValue) {
    }

    default void afterGetProperty(ConfigurablePropertyResolver propertyResolver, String name, Class<?> targetType, Object value, Object defaultValue) {
    }
    ...
    default void beforeSetValueSeparator(ConfigurablePropertyResolver propertyResolver, String valueSeparator) {
    }

    default void afterSetValueSeparator(ConfigurablePropertyResolver propertyResolver, String valueSeparator) {
    }
}
