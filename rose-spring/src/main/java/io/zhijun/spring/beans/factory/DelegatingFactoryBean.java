...
public class DelegatingFactoryBean implements FactoryBean<Object>, InitializingBean, DisposableBean,
    ...
    public void afterPropertiesSet() throws Exception {
        if (delegate instanceof org.springframework.beans.factory.InitializingBean) {
            ((org.springframework.beans.factory.InitializingBean) delegate).afterPropertiesSet();
        }
    }
    ...
    public void setApplicationContext(ApplicationContext context) throws BeansException {
        if (delegate instanceof org.springframework.context.ApplicationContextAware) {
            ((org.springframework.context.ApplicationContextAware) delegate).setApplicationContext(context);
        }
        if (delegate instanceof org.springframework.context.EnvironmentAware) {
            ((org.springframework.context.EnvironmentAware) delegate).setEnvironment(context.getEnvironment());
        }
        if (delegate instanceof org.springframework.beans.factory.BeanFactoryAware) {
            ((org.springframework.beans.factory.BeanFactoryAware) delegate).setBeanFactory(context instanceof org.springframework.context.ConfigurableApplicationContext ? ((org.springframework.context.ConfigurableApplicationContext) context).getBeanFactory() : null);
        }
    }
    ...
    public void setBeanName(String name) {
        if (delegate instanceof org.springframework.beans.factory.BeanNameAware) {
            ((org.springframework.beans.factory.BeanNameAware) delegate).setBeanName(name);
        }
    }
    ...
    public void destroy() throws Exception {
        if (delegate instanceof DisposableBean) {
            ((org.springframework.beans.factory.DisposableBean) delegate).destroy();
        }
    }
}