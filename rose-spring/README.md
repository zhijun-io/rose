...
Arconia 侧重 Quarkus CDI / 配置扩展。Rose Spring 层解决的是 **Spring `Environment` / PropertySource 增强**，与 Arconia 无直接模块对应；Dev Services 动态属性语义在 `rose-devservice` 与 Arconia 对齐。
