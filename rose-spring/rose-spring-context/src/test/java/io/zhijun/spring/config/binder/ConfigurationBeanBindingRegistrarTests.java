...
import static io.zhijun.spring.config.binder.EnableConfigurationBeanBinding.DEFAULT_IGNORE_INVALID_FIELDS;
import static io.zhijun.spring.config.binder.EnableConfigurationBeanBinding.DEFAULT_IGNORE_UNKNOWN_FIELDS;
import static io.zhijun.spring.config.binder.EnableConfigurationBeanBinding.DEFAULT_MULTIPLE;
...
import io.zhijun.spring.config.binder.ConfigurationBeanBindingRegistrar;
