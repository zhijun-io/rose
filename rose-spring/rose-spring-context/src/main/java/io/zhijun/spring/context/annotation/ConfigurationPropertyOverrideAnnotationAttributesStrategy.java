...
import static io.zhijun.spring.env.EnvironmentUtils.asConfigurableEnvironment;
import static io.zhijun.spring.env.EnvironmentUtils.getConversionService;
import static io.zhijun.spring.env.PropertySourcesUtils.getSubProperties;
import io.zhijun.spring.context.OverrideAnnotationAttributesStrategy;
import static io.zhijun.spring.env.PropertySourcesUtils.normalizePrefix;
 ...
 *                 {@code rose.spring.prefix.<AnnotationClassName>} (e.g., {@code rose.spring.prefix.org.springframework.context.annotation.PropertySource})
 *             </li>
 *             <li>Falling back to the default prefix:
 *                 {@code rose.spring.@<AnnotationSimpleName>.} (e.g., {@code rose.spring.@PropertySource.})
 *             </li>
 *         </ul>
 *     </li>
 ...
 * <pre>{@code
 * // config.properties
 * rose.spring.@PropertySource.name=my-custom-source
 * rose.spring.@PropertySource.ignoreResourceNotFound=true
 *
 ...
 * rose.spring.prefix.org.springframework.context.annotation.PropertySource=app.prop.source.
 *
...
public class ConfigurationPropertyOverrideAnnotationAttributesStrategy implements OverrideAnnotationAttributesStrategy,
    ...
    public AnnotationAttributes override(AnnotationAttributes originalAttributes, Class<? extends Annotation> annotationType,
        ...
        for (Entry<String, Object> entry : originalAttributes.entrySet()) {
            ...
            Method attributeMethod = org.springframework.util.ReflectionUtils.findMethod(annotationType, attributeName);
     ...
     * // rose.spring.prefix.PropertySource.name = "myProperties"
     * // rose.spring.prefix.PropertySource.ignoreResourceNotFound = true
     *
    ...
    protected Map<String, Object> getConfigurationProperties(Class<? extends Annotation> annotationType) {
        String propertyNamePrefix = getPropertyNamePrefix(annotationType);
        return getSubProperties(this.environment.getPropertySources(), this.environment, propertyNamePrefix);
    }
     ...
     *  // propertyName == "rose.spring.prefix.PropertySource.factory"
     * }
     * </pre>
     *
     ...
     *  // propertyNamePrefix == "rose.spring.prefix.PropertySource."
     ...
     *  // rose.spring.prefix.org.springframework.context.annotation.PropertySource = "rose.property-source."
     *  String propertyNamePrefix = getPropertyNamePrefix(PropertySource.class);
     *  // propertyNamePrefix == "rose.property-source."
     * }
     * </pre>
     *
     * @param annotationType the type of the annotation
     ...
     * <p>
     * The property name is constructed by concatenating the {@link io.zhijun.spring.constants.PropertyConstants#PREFIX_PROPERTY_NAME_PREFIX}
     ...
     *  // prefixPropertyName == "rose.spring.prefix.io.zhijun.spring.context.annotation.PropertySource"
     * }
     * </pre>
     *
     * @param annotationType the type of the annotation
     ...
     * <p>
     * The default prefix is constructed by concatenating the {@link io.zhijun.spring.constants.PropertyConstants#ROSE_SPRING_PROPERTY_NAME_PREFIX}
     ...
     *  // defaultPropertyNamePrefix == "rose.spring.@PropertySource."
     * }
     * </pre>
     *
     * @param annotationType the type of the annotation
    ...
    public static String getDefaultPropertyNamePrefix(Class<? extends Annotation> annotationType) {
        return ROSE_SPRING_PROPERTY_NAME_PREFIX + AT_CHAR + annotationType.getSimpleName() + '.';
    }
