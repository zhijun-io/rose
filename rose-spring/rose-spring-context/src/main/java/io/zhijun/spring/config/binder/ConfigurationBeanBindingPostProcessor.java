...
/**
 * Binds {@link EnableConfigurationBeanBinding} beans and runs {@link io.zhijun.spring.config.binder.ConfigurationBeanCustomizer}
 * callbacks after each bind.
 * <p>
 * Configuration beans are recognized by {@link io.zhijun.spring.config.binder.ConfigurationBeanBindingSupport#CONFIGURATION_BEAN_SOURCE}
