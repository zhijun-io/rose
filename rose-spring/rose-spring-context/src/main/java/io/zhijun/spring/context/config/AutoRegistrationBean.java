...
import io.zhijun.spring.context.annotation.EnableAutoRegistrationBean;
...
import static io.zhijun.spring.constants.PropertyConstants.DOT_CHAR;
...
public interface AutoRegistrationBean extends Ordered {
    ...
    /**
     * The property name pattern of auto-registration bean : "rose.spring.beans.{bean-name}.auto-registered"
     */
    String AUTO_REGISTERED_BEAN_PROPERTY_NAME_PATTERN = BEANS_PROPERTY_NAME_PREFIX + "{}" + DOT_CHAR +
    ...
    static String generateBeanName(Class<?> beanType) {
        return java.beans.Introspector.decapitalize(beanType.getSimpleName());
    }
