 ...
 * <ul>
 *     <li>{@code rose.spring.listenable-autowire-candidate-resolver.enabled} -
 ...
 * <pre>
 * rose.spring.listenable-autowire-candidate-resolver.enabled=true
 * </pre>
 *
 * <p><strong> spring.factories (Spring Boot):</strong></p>
 * <pre>{@code
 * org.springframework.context.ApplicationContextInitializer=\
 * io.zhijun.spring.beans.factory.support.ListenableAutowireCandidateResolverInitializer
 * }</pre>
 *
 ...
 *  .properties("rose.spring.listenable-autowire-candidate-resolver.enabled=true")
 *  .run(args);
 * }</pre>
 *
...
public class ListenableAutowireCandidateResolverInitializer extends ConfigurableApplicationContextInitializer {
    ...
    /**
     * The prefix of the property name of {@link ListenableAutowireCandidateResolver} : "rose.spring.listenable-autowire-candidate-resolver."
     */
    public static final String PROPERTY_NAME_PREFIX = ROSE_SPRING_PROPERTY_NAME_PREFIX + "listenable-autowire-candidate-resolver.";

    private static final String DEFAULT_ENABLED = "false";

    /**
     * The property name of {@link ListenableAutowireCandidateResolver} to be 'enabled' : "rose.spring.listenable-autowire-candidate-resolver.enabled"
     */
