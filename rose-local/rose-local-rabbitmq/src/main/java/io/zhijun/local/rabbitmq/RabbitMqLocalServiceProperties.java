 ...
 */
@ConfigurationProperties(prefix = RabbitMqLocalServiceProperties.CONFIG_PREFIX)
public class RabbitMqLocalServiceProperties implements BaseLocalServiceProperties {
