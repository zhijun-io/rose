...
import io.zhijun.local.rabbitmq.RabbitMqDevServicesAutoConfiguration.RabbitMqLocalServiceRegistrar;
...
@EnableConfigurationProperties(RabbitMqLocalServiceProperties.class)
...
public final class RabbitMqDevServicesAutoConfiguration {
    ...
    static class RabbitMqLocalServiceRegistrar extends LocalServiceRegistrar {
        ...
        protected void registerDevServices(LocalServiceRegistry registry, Environment environment) {
            final RabbitMqLocalServiceProperties properties = bindProperties(
                    RabbitMqLocalServiceProperties.CONFIG_PREFIX, RabbitMqLocalServiceProperties.class);
