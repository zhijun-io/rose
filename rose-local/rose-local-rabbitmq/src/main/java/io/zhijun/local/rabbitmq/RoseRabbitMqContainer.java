...
/**
 * RabbitMQ container configured for Rose Local.
 */
final class RoseRabbitMqContainer extends RabbitMQContainer {
    ...
    private final RabbitMqLocalServiceProperties properties;

    RoseRabbitMqContainer(RabbitMqLocalServiceProperties properties) {
