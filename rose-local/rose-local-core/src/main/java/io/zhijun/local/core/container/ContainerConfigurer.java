...
public final class ContainerConfigurer {
     ...
     */
    public static void base(GenericContainer<?> container, BaseLocalServiceProperties properties) {
        container
    ...
    public static void resources(GenericContainer<?> container, BaseLocalServiceProperties properties) {
    ...
    public static void volumes(GenericContainer<?> container, BaseLocalServiceProperties properties) {
    ...
    public static void jdbc(JdbcDatabaseContainer<?> container, JdbcLocalServiceProperties properties) {
        container
