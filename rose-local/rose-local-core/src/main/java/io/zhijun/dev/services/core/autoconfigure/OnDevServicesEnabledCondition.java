...
/**
 * Condition for {@link ConditionalOnDevServicesEnabled}.
 */
class OnDevServicesEnabledCondition extends SpringBootCondition {
    ...
    private static final String DEV_SERVICES_PROPERTY = "rose.dev.services.%s.enabled";

    @Override
    public ConditionOutcome getMatchOutcome(ConditionContext context, AnnotatedTypeMetadata metadata) {
        Map<String, Object> attributes = metadata.getAnnotationAttributes(
                ConditionalOnDevServicesEnabled.class.getName());
