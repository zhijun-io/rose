...
/**
 * Unit tests for {@link BaseLocalServiceProperties} defaults.
 */
class BaseLocalServicePropertiesTests {

  @Test
  void defaultMethods() {
    BaseLocalServiceProperties properties = new BaseLocalServiceProperties() {
