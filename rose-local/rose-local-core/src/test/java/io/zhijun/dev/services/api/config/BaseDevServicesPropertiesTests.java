...
/**
 * Unit tests for {@link BaseDevServicesProperties} defaults.
 */
class BaseDevServicesPropertiesTests {

  @Test
  void defaultMethods() {
    BaseDevServicesProperties properties = new BaseDevServicesProperties() {
