...
class DevServicesRegistrarTests {
    ...
    void noRegistrations() {
        doRegister(new Consumer<DevServicesRegistry>() {
            @Override
            public void accept(DevServicesRegistry registry) {
            }
        });
    ...
    void setDefaultPropertyAddsToDefaultPropertiesSource() {
        TestRegistrar registrar = new TestRegistrar(new Consumer<DevServicesRegistry>() {
            @Override
            public void accept(DevServicesRegistry registry) {
            }
    ...
    private static class TestRegistrar extends DevServicesRegistrar {
        ...
        TestRegistrar(Consumer<DevServicesRegistry> registrar, Environment environment,
