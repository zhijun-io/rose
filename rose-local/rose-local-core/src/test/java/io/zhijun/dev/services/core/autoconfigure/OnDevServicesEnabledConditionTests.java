...
class OnDevServicesEnabledConditionTests {
    ...
    void shouldMatchWhenGloballyEnabledAndSpecificDevServiceEnabled() {
        environment.setProperty("rose.dev.services.enabled", "true");
        environment.setProperty("rose.dev.services.test-service.enabled", "true");
        ...
        assertThat(outcome.getMessage())
                .contains("rose.dev.services.test-service.enabled is set to true");
    }

    @Test
    void shouldNotMatchWhenGloballyEnabledButSpecificDevServiceDisabled() {
        environment.setProperty("rose.dev.services.enabled", "true");
        environment.setProperty("rose.dev.services.test-service.enabled", "false");
        when(context.getEnvironment()).thenReturn(environment);
        ...
        assertThat(outcome.getMessage())
                .contains("rose.dev.services.test-service.enabled is set to false");
    }

    @Test
    void shouldNotMatchWhenGloballyDisabledAndSpecificDevServiceEnabled() {
        environment.setProperty("rose.dev.services.enabled", "false");
        environment.setProperty("rose.dev.services.test-service.enabled", "true");
        when(context.getEnvironment()).thenReturn(environment);
        ...
        assertThat(outcome.isMatch()).isFalse();
        assertThat(outcome.getMessage())
                .contains("rose.dev.services.enabled is set to false");
    }
    ...
    void shouldMatchByDefaultWhenPropertiesAreNotSet() {
        ...
        assertThat(outcome.isMatch()).isTrue();
        assertThat(outcome.getMessage())
                .contains("enabled by default (rose.dev.services.test-service.enabled is not set)");
    }
