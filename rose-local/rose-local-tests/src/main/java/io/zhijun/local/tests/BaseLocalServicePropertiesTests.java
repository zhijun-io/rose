...
/**
 * Abstract base test class for testing {@link BaseLocalServiceProperties} implementations.
 *
 * @param <T> the specific {@link BaseLocalServiceProperties} implementation type
 */
public abstract class BaseLocalServicePropertiesTests<T extends BaseLocalServiceProperties> {
