...
import static io.zhijun.dev.services.api.config.JdbcDevServicesProperties.DEFAULT_DB_NAME;
import static io.zhijun.dev.services.api.config.JdbcDevServicesProperties.DEFAULT_PASSWORD;
import static io.zhijun.dev.services.api.config.JdbcDevServicesProperties.DEFAULT_USERNAME;
 ...
 */
public abstract class BaseJdbcDevServicesPropertiesTests<T extends JdbcDevServicesProperties>
        extends BaseDevServicesPropertiesTests<T> {
