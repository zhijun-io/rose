...
/**
 * MySQL container configured for Rose Local.
 */
final class RoseMySqlContainer extends MySQLContainer<RoseMySqlContainer> {

    static final String COMPATIBLE_IMAGE_NAME = "mysql";

    private final MySqlLocalServiceProperties properties;

    RoseMySqlContainer(MySqlLocalServiceProperties properties) {
