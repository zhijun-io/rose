...
import io.zhijun.local.mysql.MySqlDevServicesAutoConfiguration.MySqlLocalServiceRegistrar;
...
@EnableConfigurationProperties(MySqlLocalServiceProperties.class)
...
public final class MySqlDevServicesAutoConfiguration {
    ...
    static class MySqlLocalServiceRegistrar extends LocalServiceRegistrar {
        ...
        protected void registerDevServices(LocalServiceRegistry registry, Environment environment) {
            final MySqlLocalServiceProperties properties = bindProperties(
                    MySqlLocalServiceProperties.CONFIG_PREFIX, MySqlLocalServiceProperties.class);
