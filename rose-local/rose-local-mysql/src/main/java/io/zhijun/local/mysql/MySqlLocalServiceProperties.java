 ...
 */
@ConfigurationProperties(prefix = MySqlLocalServiceProperties.CONFIG_PREFIX)
public class MySqlLocalServiceProperties implements JdbcLocalServiceProperties {
