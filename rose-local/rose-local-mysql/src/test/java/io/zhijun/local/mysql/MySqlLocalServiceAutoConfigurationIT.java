...
import io.zhijun.local.tests.BaseJdbcLocalServiceAutoConfigurationIT;

import static io.zhijun.local.api.provider.LocalServiceCategories.MYSQL;
import static io.zhijun.local.mysql.MySqlLocalServiceProperties.DEFAULT_DB_NAME;
import static io.zhijun.local.mysql.MySqlLocalServiceProperties.DEFAULT_PASSWORD;
import static io.zhijun.local.mysql.MySqlLocalServiceProperties.DEFAULT_USERNAME;
import static org.assertj.core.api.Assertions.assertThat;

/**
 * Integration tests for {@link MySqlDevServicesAutoConfiguration}.
 */
class MySqlLocalServiceAutoConfigurationIT extends BaseJdbcLocalServiceAutoConfigurationIT {
