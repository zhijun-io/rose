...
import io.zhijun.local.kafka.KafkaDevServicesAutoConfiguration.KafkaLocalServiceRegistrar;
...
@EnableConfigurationProperties(KafkaLocalServiceProperties.class)
...
public final class KafkaDevServicesAutoConfiguration {
    ...
    static class KafkaLocalServiceRegistrar extends LocalServiceRegistrar {
        ...
        protected void registerDevServices(LocalServiceRegistry registry, Environment environment) {
            final KafkaLocalServiceProperties properties = bindProperties(
                    KafkaLocalServiceProperties.CONFIG_PREFIX, KafkaLocalServiceProperties.class);
