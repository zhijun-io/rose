 ...
 */
@ConfigurationProperties(prefix = KafkaLocalServiceProperties.CONFIG_PREFIX)
public class KafkaLocalServiceProperties implements BaseLocalServiceProperties {
