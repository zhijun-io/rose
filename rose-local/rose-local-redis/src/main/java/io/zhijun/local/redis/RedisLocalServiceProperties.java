 ...
 */
@ConfigurationProperties(prefix = RedisLocalServiceProperties.CONFIG_PREFIX)
public class RedisLocalServiceProperties implements BaseLocalServiceProperties {
