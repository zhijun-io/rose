...
/**
 * Redis container configured for Rose Local.
 */
final class RoseRedisContainer extends GenericContainer<RoseRedisContainer> {
    ...
    private final RedisLocalServiceProperties properties;

    RoseRedisContainer(RedisLocalServiceProperties properties) {
