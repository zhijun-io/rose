 ...
 */
@ConfigurationProperties(prefix = PostgresqlLocalServiceProperties.CONFIG_PREFIX)
public class PostgresqlLocalServiceProperties implements JdbcLocalServiceProperties {
