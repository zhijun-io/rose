...
/**
 * PostgreSQL container configured for Rose Local.
 */
final class RosePostgreSqlContainer extends PostgreSQLContainer<RosePostgreSqlContainer> {
    ...
    private final PostgresqlLocalServiceProperties properties;

    RosePostgreSqlContainer(PostgresqlLocalServiceProperties properties) {
