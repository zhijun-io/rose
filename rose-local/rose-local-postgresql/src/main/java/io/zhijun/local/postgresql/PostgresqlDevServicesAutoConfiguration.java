...
import io.zhijun.local.postgresql.PostgresqlDevServicesAutoConfiguration.PostgresqlLocalServiceRegistrar;
...
@EnableConfigurationProperties(PostgresqlLocalServiceProperties.class)
...
public final class PostgresqlDevServicesAutoConfiguration {
    ...
    static class PostgresqlLocalServiceRegistrar extends LocalServiceRegistrar {
        ...
        protected void registerDevServices(LocalServiceRegistry registry, Environment environment) {
            final PostgresqlLocalServiceProperties properties = bindProperties(
                    PostgresqlLocalServiceProperties.CONFIG_PREFIX, PostgresqlLocalServiceProperties.class);
