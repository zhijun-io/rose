...
import static io.zhijun.local.postgresql.RosePostgreSqlContainer.READY_REGEX;
import static io.zhijun.local.postgresql.RosePostgreSqlContainer.SKIPPING_INITIALIZATION_REGEX;
...
class RosePostgreSqlContainerTests extends BaseDevServicesContainerTests<RosePostgreSqlContainer> {
    ...
    void whenExposedPortsAreNotConfigured() {
        RosePostgreSqlContainer container = new RosePostgreSqlContainer(new PostgresqlLocalServiceProperties());
        container.configure();
    ...
    void whenExposedPortsAreConfigured() {
        PostgresqlLocalServiceProperties properties = new PostgresqlLocalServiceProperties();
