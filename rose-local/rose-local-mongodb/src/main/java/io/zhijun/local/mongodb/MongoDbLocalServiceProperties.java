 ...
 */
@ConfigurationProperties(prefix = MongoDbLocalServiceProperties.CONFIG_PREFIX)
public class MongoDbLocalServiceProperties implements BaseLocalServiceProperties {
