...
class RoseOtelCollectorContainerTests extends BaseDevServicesContainerTests<RoseOtelCollectorContainer> {
    ...
    void whenExposedPortsAreNotConfigured() {
        RoseOtelCollectorContainer container = new RoseOtelCollectorContainer(new OtelCollectorLocalServiceProperties());
        container.configure();
    ...
    void whenExposedPortsAreConfigured() {
        OtelCollectorLocalServiceProperties properties = new OtelCollectorLocalServiceProperties();
