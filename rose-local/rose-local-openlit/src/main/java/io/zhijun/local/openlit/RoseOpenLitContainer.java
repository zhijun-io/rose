...
/**
 * OpenLit container configured for Rose Local.
 */
final class RoseOpenLitContainer extends GenericContainer<RoseOpenLitContainer> {

    private static final Logger logger = LoggerFactory.getLogger(RoseOpenLitContainer.class);
    ...
    private final OpenLitLocalServiceProperties properties;

    private DockerImageName clickHouseImageName = DEFAULT_CLICKHOUSE_IMAGE_NAME;

    RoseOpenLitContainer(OpenLitLocalServiceProperties properties) {
    ...
    protected void configure() {
        ...
        RoseClickHouseSidecar clickHouseContainer = new RoseClickHouseSidecar(
     ...
     */
    private static final class RoseClickHouseSidecar extends GenericContainer<RoseClickHouseSidecar> {

        RoseClickHouseSidecar(DockerImageName dockerImageName) {
