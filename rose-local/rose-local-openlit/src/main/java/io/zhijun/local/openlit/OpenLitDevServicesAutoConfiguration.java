...
import io.zhijun.local.openlit.OpenLitDevServicesAutoConfiguration.OpenLitLocalServiceRegistrar;
...
@EnableConfigurationProperties(OpenLitLocalServiceProperties.class)
...
public final class OpenLitDevServicesAutoConfiguration {
    ...
    static class OpenLitLocalServiceRegistrar extends LocalServiceRegistrar {
        ...
        protected void registerDevServices(LocalServiceRegistry registry, Environment environment) {
            final OpenLitLocalServiceProperties properties = bindProperties(
                    OpenLitLocalServiceProperties.CONFIG_PREFIX, OpenLitLocalServiceProperties.class);
