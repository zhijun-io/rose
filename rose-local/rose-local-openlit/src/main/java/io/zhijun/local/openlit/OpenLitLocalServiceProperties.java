 ...
 */
@ConfigurationProperties(prefix = OpenLitLocalServiceProperties.CONFIG_PREFIX)
public class OpenLitLocalServiceProperties implements BaseLocalServiceProperties {
