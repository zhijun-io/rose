 ...
 */
@ConfigurationProperties(prefix = ArtemisLocalServiceProperties.CONFIG_PREFIX)
public class ArtemisLocalServiceProperties implements BaseLocalServiceProperties {
    ...
    private String imageName = "apache/activemq-artemis:2.31.2-alpine";
