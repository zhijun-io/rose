 ...
 */
class ArtemisLocalServiceAutoConfigurationIT extends BaseLocalServiceAutoConfigurationIT {
    ...
    void containerAvailableInDevMode() {
        assertContainerAvailableInDevMode(
                ...
                container -> {
                    ...
                    assertThat(container.getUsername()).isEqualTo(ArtemisLocalServiceProperties.DEFAULT_USERNAME);
                    assertThat(container.getPassword()).isEqualTo(ArtemisLocalServiceProperties.DEFAULT_PASSWORD);
                });
    }
