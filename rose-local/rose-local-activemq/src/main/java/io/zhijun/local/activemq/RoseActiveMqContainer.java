...
/**
 * ActiveMQ Classic container for Rose Local.
 */
final class RoseActiveMqContainer extends GenericContainer<RoseActiveMqContainer> {
    ...
    private final ActiveMqLocalServiceProperties properties;

    RoseActiveMqContainer(ActiveMqLocalServiceProperties properties) {
