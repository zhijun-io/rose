 ...
 */
@ConfigurationProperties(prefix = ActiveMqLocalServiceProperties.CONFIG_PREFIX)
public class ActiveMqLocalServiceProperties implements BaseLocalServiceProperties {
