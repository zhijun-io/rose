 ...
 */
@ConfigurationProperties(prefix = ActiveMqDevServicesProperties.CONFIG_PREFIX)
public class ActiveMqDevServicesProperties implements BaseDevServicesProperties {

    public static final String CONFIG_PREFIX = "rose.dev.services.activemq";
