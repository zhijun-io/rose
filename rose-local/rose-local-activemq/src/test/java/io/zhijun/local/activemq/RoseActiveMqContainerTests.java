...
class RoseActiveMqContainerTests extends BaseDevServicesContainerTests<RoseActiveMqContainer> {
    ...
    void whenExposedPortsAreNotConfigured() {
        RoseActiveMqContainer container = new RoseActiveMqContainer(new ActiveMqLocalServiceProperties());
        container.configure();
    ...
    void whenExposedPortsAreConfigured() {
        ActiveMqLocalServiceProperties properties = new ActiveMqLocalServiceProperties();
