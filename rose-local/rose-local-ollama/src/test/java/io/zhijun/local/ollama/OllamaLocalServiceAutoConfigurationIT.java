 ...
 */
class OllamaLocalServiceAutoConfigurationIT extends BaseLocalServiceAutoConfigurationIT {
    ...
    void containerConfigurationApplied() {
        assertContainerConfigurationApplied(
                ...
                (context, container) -> assertThat(
                        context.getEnvironment().getProperty(OllamaLocalServiceProperties.BASE_URL_PROPERTY))
                        .startsWith("http://"));
    }
}
