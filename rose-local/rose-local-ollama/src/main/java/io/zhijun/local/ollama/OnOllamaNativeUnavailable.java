...
class OnOllamaNativeUnavailable extends SpringBootCondition {
    ...
    public ConditionOutcome getMatchOutcome(ConditionContext context, AnnotatedTypeMetadata metadata) {
        ...
        try {
            OllamaLocalServiceProperties devServicesProperties = Binder.get(environment)
                    .bindOrCreate(OllamaLocalServiceProperties.CONFIG_PREFIX, OllamaLocalServiceProperties.class);
            ...
            if (devServicesProperties.isIgnoreNativeService()) {
                return ConditionOutcome.match(String.format(
                        ...
                        OllamaLocalServiceProperties.CONFIG_PREFIX + ".ignore-native-service",
