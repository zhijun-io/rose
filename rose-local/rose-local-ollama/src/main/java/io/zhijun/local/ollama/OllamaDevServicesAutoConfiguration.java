...
import io.zhijun.local.ollama.OllamaDevServicesAutoConfiguration.OllamaLocalServiceRegistrar;
...
@EnableConfigurationProperties(OllamaLocalServiceProperties.class)
...
public final class OllamaDevServicesAutoConfiguration {
    ...
    static class OllamaLocalServiceRegistrar extends LocalServiceRegistrar {
        ...
        private static final String OLLAMA_BASE_URL_PROPERTY = OllamaLocalServiceProperties.BASE_URL_PROPERTY;

        @Override
        protected void registerDevServices(LocalServiceRegistry registry, Environment environment) {
            final OllamaLocalServiceProperties properties = bindProperties(
                    OllamaLocalServiceProperties.CONFIG_PREFIX, OllamaLocalServiceProperties.class);
