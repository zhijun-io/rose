...
public final class OpenTelemetryExporterConditionSupport {
    ...
    public static ConditionOutcome evaluate(ConditionContext context, AnnotatedTypeMetadata metadata,
            Class<? extends Annotation> annotationType, String signalExporterTypeProperty) {
        ...
        String signalExporterTypeString = context.getEnvironment().getProperty(signalExporterTypeProperty, String.class);
        ExporterType signalExporterType = StringUtils.hasText(signalExporterTypeString)
                ? ExporterType.valueOf(signalExporterTypeString.toUpperCase()) : null;
        ...
        if (signalExporterType != null) {
            ...
            return ConditionOutcome.noMatch(ConditionMessage.forCondition(annotationType)
                    .because(signalExporterTypeProperty + " is set to " + signalExporterType
                            + ", but requested " + requestedExporterType));
        }
