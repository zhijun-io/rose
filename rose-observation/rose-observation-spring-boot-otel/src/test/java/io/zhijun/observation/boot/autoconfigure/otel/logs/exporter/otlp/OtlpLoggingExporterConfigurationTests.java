...
import io.zhijun.observation.boot.autoconfigure.otel.logs.exporter.OpenTelemetryLoggingExporterAutoConfiguration;
        ...
        contextRunner
                ...
                .run(context -> {
                    OtlpLoggingConnectionDetails connectionDetails =
                            context.getBean(OtlpLoggingConnectionDetails.class);
