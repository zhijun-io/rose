...
/**
 * Unit test for {@link OnOpenTelemetryMetricsExporterCondition}.
 */
class OnOpenTelemetryMetricsExporterConditionTests {
    ...
    void shouldMatchWhenMetricsExporterTypeMatches() {
        ...
        assertThat(outcome.getMessage()).contains("rose.otel.metrics.exporter.type is set to CONSOLE");
    }
    ...
    void shouldNotMatchWhenExporterTypeDoesNotMatch() {
        ...
        assertThat(outcome.getMessage())
                .contains("rose.otel.metrics.exporter.type is set to CONSOLE, but requested none");
    }
    ...
    void shouldPrioritizeMetricsExporterTypeOverGeneralExporterType() {
        ...
        environment.setProperty("rose.otel.metrics.exporter.type", "otlp");
        when(context.getEnvironment()).thenReturn(environment);
        ...
        assertThat(outcome.isMatch()).isTrue();
        assertThat(outcome.getMessage()).contains("rose.otel.metrics.exporter.type is set to OTLP");
    }
