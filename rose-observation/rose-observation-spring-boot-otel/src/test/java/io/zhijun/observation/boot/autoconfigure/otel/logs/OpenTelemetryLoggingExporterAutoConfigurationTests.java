...
import io.zhijun.observation.boot.autoconfigure.otel.logs.OtlpLoggingExporterConfiguration;
...
class OpenTelemetryLoggingExporterAutoConfigurationTests {
    ...
    private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            .withConfiguration(AutoConfigurations.of(
                    OpenTelemetryExporterAutoConfiguration.class, OpenTelemetryLoggingExporterAutoConfiguration.class));
    ...
    void autoConfigurationNotActivatedWhenOpenTelemetryDisabled() {
        contextRunner
                ...
                .run(context ->
                        assertThat(context).doesNotHaveBean(OpenTelemetryLoggingExporterAutoConfiguration.class));
    }
