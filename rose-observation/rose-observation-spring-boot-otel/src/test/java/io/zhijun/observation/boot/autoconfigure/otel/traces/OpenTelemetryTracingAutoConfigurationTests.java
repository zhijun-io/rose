...
class OpenTelemetryTracingAutoConfigurationTests {
    ...
    void batchSpanProcessorNotCreatedWithoutExporter() {
        contextRunner.run(context -> assertThat(context).doesNotHaveBean(BatchSpanProcessor.class));
    }
    ...
    void otelSpanProcessorConfigurationApplied() {
        contextRunner
                ...
                .run(context -> {
                    ...
                    assertThat(context)
                            .getBeanNames(BatchSpanProcessor.class)
                            .hasSize(1)
    ...
    void customContextPropagatorsAvailable() {
        contextRunner
                ...
                .run(context -> {
                    assertThat(context).hasSingleBean(ContextPropagators.class);
                    assertThat(context)
                            .getBeanNames(TextMapPropagator.class)
                            .hasSize(1)
    ...
    static class CustomTracerProviderConfiguration {
        ...
        private final OpenTelemetryTracerProviderBuilderCustomizer customizer =
                mock(OpenTelemetryTracerProviderBuilderCustomizer.class);
