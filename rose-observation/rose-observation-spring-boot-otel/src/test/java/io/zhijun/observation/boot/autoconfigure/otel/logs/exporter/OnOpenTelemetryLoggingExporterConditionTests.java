...
class OnOpenTelemetryLoggingExporterConditionTests {
    ...
    private final OnOpenTelemetryLoggingExporterCondition condition = new OnOpenTelemetryLoggingExporterCondition();
    ...
    @Test
    void shouldMatchWhenLogsExporterTypeMatches() {
        environment.setProperty("rose.otel.logs.exporter.type", "console");
        when(context.getEnvironment()).thenReturn(environment);

        AnnotatedTypeMetadata metadata = mock(AnnotatedTypeMetadata.class);
        Map<String, Object> attributes = new HashMap<>();
        attributes.put("value", "console");
        when(metadata.getAnnotationAttributes(ConditionalOnOpenTelemetryLoggingExporter.class.getName()))
    ...
    @Test
    void shouldPrioritizeLogsExporterTypeOverGeneralExporterType() {
        environment.setProperty("rose.otel.exporter.type", "console");
        environment.setProperty("rose.otel.logs.exporter.type", "otlp");
        when(context.getEnvironment()).thenReturn(environment);
